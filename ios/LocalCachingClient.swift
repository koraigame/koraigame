...
@objc class LocalCachingClient: NSObject, SubjectLevelGetter {
  ...
  private var _availableSubjects = Cached<(Int, [ReviewComposition])>(n: .lccAvailableItemsChanged)
  var availableSubjects: (lessonCount: Int, reviewComposition: [ReviewComposition]) {
  ...
  var availableReviewCount: Int {
    return availableSubjects.reviewComposition.first?.availableReviews ?? 0
  }
  ...
  var upcomingReviews: [Int] {
    return availableSubjects.reviewComposition[1...].map { return $0.availableReviews }
  }
}
